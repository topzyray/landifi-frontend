...
const Footer = () => {
  return (
    <section className="w-full shadow-lg bg-black/70 text-white px-4 py-10 lg:px-[5rem] lg:py-[5rem]">
      <section className="grid place-items-stretch grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-5 sm:gap-16 lg:gap-20 font-semibold">
        ...
        {footerNavs.map((nav) => (
          <section key={nav.id} className="lg:row-start-1 lg:col-span-2">
            <h4 className="text-base font-semibold mb-4 underline">{nav.header}</h4>
        ...
        <section className="lg:row-start-2 col-span-full text-left md:text-center ">
